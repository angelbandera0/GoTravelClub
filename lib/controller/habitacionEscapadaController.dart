...
import 'detallesEscapadaController.dart';

class HabitacionEscapadaController extends GetxController {
  List<TextEditingController> _listaControllers = [];
  List<Widget> camposEdades = [];
  late DetallesEscapadaController dac;

  @override
  void onInit() {
    // TODO: implement onInit
    super.onInit();
    dac=Get.find<DetallesEscapadaController>();
  }
