...
class CardCotizacionVuelo extends StatelessWidget {
  final Color color;
  final String title;
  final IconData icon;
  final Info info;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text((info.airportdestiny != "")
                                  ? "${info.airportdestiny}"
                                  : "No hay, es solo ida"),
                            ),
                            TitleWithDivider(
  ...
  _launchURL() async {
    var url =
        'https://www.gotravelclub.com.ec/validate_quote/?pk=${info.pk}&type="flights"}';
