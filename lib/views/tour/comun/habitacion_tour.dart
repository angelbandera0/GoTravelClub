...
class HabitacionTour extends StatelessWidget {
  ...
  late HabitacionTourController habitacionController;

  HabitacionTour({Key? key, required this.index}) : super(key: key){
    Get.create(() => HabitacionTourController());
    habitacionController = Get.find<HabitacionTourController>();
  }
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListadoEdadesMenoresTour(id: _idListMenores+this.index.toString(), habitacionController: habitacionController,)
          ],
        ),
      );});
  }
